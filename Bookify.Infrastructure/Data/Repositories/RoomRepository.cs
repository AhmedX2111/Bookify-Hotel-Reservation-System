// Bookify-Hotel-Reservation-System-master/Bookify.Infrastructure/Data/Repositories/RoomRepository.cs
...
namespace Bookify.Infrastructure.Data.Data.Repositories
{
    public class RoomRepository : Repository<Room>, IRoomRepository
    {
        ...
        public async Task<IEnumerable<Room>> GetAllRoomsWithTypesAsync(CancellationToken cancellationToken = default)
        {
            return await _dbContext.Rooms
                .Include(r => r.RoomType)
        ...
        public async Task<Room?> GetRoomByIdWithTypeAsync(int id, CancellationToken cancellationToken = default)
        {
            return await _dbContext.Rooms
                .Include(r => r.RoomType)
